...
parser = argparse.ArgumentParser(description='LiquidSR')
...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/home/pangu/linhanjiang/dataset/',
...
parser.add_argument('--model', default='LiquidSR',
                    help='model name')
