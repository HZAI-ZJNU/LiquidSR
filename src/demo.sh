...
#python main.py --template RCAN --data_test Set5 --save RCAN_2 --scale 2 --test_only --pre_train ../experiment/RCAN/model/RCAN_BIX2.pt
#python main.py --model RCAN --data_test Set5+Set14+B100+Urban100+DIV2K --save RCAN_BIX2 --scale 2 --n_resgroups 10 --n_resblocks 20 --n_feats 64  --reset --save_results --test_only  --pre_train ../experiment/RCAN/model/RCAN_BIX2.pt
...
#python main.py --model EDSR --data_test DIV2K --data_range 801-900 --scale 2 --save EDSR_x2 --n_resblocks 32 --n_feats 256 --res_scale 0.1 --pre_train ../experiment/model/EDSR/EDSR_x2.pt --test_only --save_results
#python main.py --model EDSR --data_test Set5+Set14+B100+Urban100+DIV2K --scale 2 --save EDSR_x2 --n_resblocks 32 --n_feats 256 --res_scale 0.1 --pre_train /home/mjuzk/pythonProject/EDSR/src/EDSR_x2.pt --test_only --save_results
#python main.py --model EDSR --data_test Set5+Set14+B100+Urban100+DIV2K --scale 3 --save EDSR_x3 --n_resblocks 32 --n_feats 256 --res_scale 0.1 --pre_train /home/mjuzk/pythonProject/EDSR/src/EDSR_x3.pt --test_only --save_results
#python main.py --model EDSR --data_test Set5+Set14+B100+Urban100+DIV2K --scale 4 --save EDSR_x4 --n_resblocks 32 --n_feats 256 --res_scale 0.1 --pre_train /home/mjuzk/pythonProject/EDSR/src/EDSR_x4.pt --test_only --save_results
#python main.py --model EDSR --data_test Set5+Set14+B100+Urban100+DIV2K --data_range 801-900 --scale 4 --save EDSR_x4 --n_resblocks 32 --n_feats 256 --res_scale 0.1 --pre_train ../experiment/model/EDSR/EDSR_x4.pt --test_only --save_results
#python main.py --model RDN --scale 3 --n_resblocks 32 --n_feats 256 --save rdn_x3

#python main.py --model ReResNet
python /home/pangu/linhanjiang/code/LiquidSR/LiquidSR/LiquidSR/src/main.py --model liquidsr --data_test Set5+Set14+B100+Urban100+Manga109 --scale 4 --save LiquidSR --pre_train /home/pangu/linhanjiang/code/LiquidSR/LiquidSR/LiquidSR/experiment/test/model/model_best.pt --rgb_range 1 --test_only --save_results

python /home/pangu/linhanjiang/code/LiquidSR/LiquidSR/LiquidSR/src/main.py --model liquidsr --data_test Set5+Set14+B100+Urban100+Manga109 --scale 2 --save LiquidSR --pre_train /home/pangu/linhanjiang/code/LiquidSR/LiquidSR/LiquidSR/experiment/test/model/X2.pt --rgb_range 1 --test_only --save_results

python /home/pangu/linhanjiang/code/LiquidSR/LiquidSR/LiquidSR/src/main.py --model liquidsr --data_test Set5+Set14+B100+Urban100+Manga109 --scale 3 --save LiquidSR --pre_train /home/pangu/linhanjiang/code/LiquidSR/LiquidSR/LiquidSR/experiment/test/model/X3.pt --rgb_range 1 --test_only --save_results

python /home/pangu/linhanjiang/code/LiquidSR/LiquidSR/LiquidSR/src/main.py --model liquidsr --data_test Set5+Set14+B100+Urban100+Manga109 --scale 4 --save LiquidSR --pre_train /home/pangu/linhanjiang/code/LiquidSR/LiquidSR/LiquidSR/experiment/test/model/X4.pt --rgb_range 1 --test_only --save_results
